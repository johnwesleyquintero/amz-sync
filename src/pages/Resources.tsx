    ...
    <MainLayout>
      <div className="animate-fade-in">
        ...
        <div className="space-y-6">
          ...
          {/*
          <section className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800 dark:border dark:border-gray-700">
            <h2 className="text-xl font-semibold mb-4 text-text-primary">Seller Guides</h2>
          ...
          <section className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800 dark:border dark:border-gray-700">
            <h2 className="text-xl font-semibold mb-4 text-text-primary">Recommended Tools</h2>
            <p className="text-text-secondary">A list of useful third-party tools and services for keyword research, competitor analysis, inventory management, etc...</p>
          </section>

          <section className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800 dark:border dark:border-gray-700">
            <h2 className="text-xl font-semibold mb-4 text-text-primary">Industry Articles & News</h2>
            <p className="text-text-secondary">Links to relevant articles and updates in the e-commerce space...</p>
          </section>
          */}
        </div>
      </div>

...
const searchTerms = [
  { term: "wireless earbuds", clicks: 2456, impressions: 34567, ctr: 7.1, rank: 2.3 },
  { term: "bluetooth speaker", clicks: 1932, impressions: 28456, ctr: 6.8, rank: 3.1 },
  { term: "phone charger", clicks: 1854, impressions: 25678, ctr: 7.2, rank: 2.7 },
        ...
        <div className="bg-gradient-to-r from-burnt-sienna to-shakespeare p-6 rounded-lg text-white">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              ...
              <p className="mb-4 md:mb-0">Sync your Amazon data with Google Sheets for advanced analysis</p>
            </div>

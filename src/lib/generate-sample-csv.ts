...
const testDataMapping: TestDataMapping = {
  ...
  'competitor-analyzer': generateSampleCsv('competitor-analyzer'),
  'sales-estimator': generateSampleCsv('sales-estimator'),
  'keyword-optimization': generateSampleCsv('keyword-optimization'),
  'keyword-trend-analyzer': generateSampleCsv('keyword-trend-analyzer'),
  'keyword-analyzer': generateSampleCsv('keyword-analyzer'),
  'keyword-deduplicator': generateSampleCsv('keyword-deduplicator'),
  'listing-optimization': generateSampleCsv('listing-optimization'),
  'listing-quality-checker': generateSampleCsv('listing-quality-checker'),
  'description-editor': generateSampleCsv('description-editor'),
  'acos-calculator': generateSampleCsv('acos-calculator'),
  'ppc-campaign-auditor': generateSampleCsv('ppc-campaign-auditor'),
  'profit-margin-calculator': generateSampleCsv('profit-margin-calculator'),
  'fba-calculator': generateSampleCsv('fba-calculator'),
  fba: generateSampleCsv('fba'),
  keyword: generateSampleCsv('keyword'),
  ppc: generateSampleCsv('ppc'),
  acos: generateSampleCsv('acos'),
  description: generateSampleCsv('description'),
};

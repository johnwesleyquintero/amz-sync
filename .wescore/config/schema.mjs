...
const CommandCheckSchema = z.object({
  id: z.string({ required_error: 'Check ID is required.' }).min(1, 'Check ID cannot be empty.'),
  name: z
  ...
  description: z.string().optional().describe('Optional description of what the check does.'),
  fallback: z
    .string()
    .optional()
    .describe(
  ...
  timeout: z
    ...
    .optional()
    .describe('Optional timeout override for this specific command in milliseconds.'),
});
